...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo bg-light">
            <a href="index.php"><img src="images/batallogo.jpg" class="img-circle" alt="" width="100" height="100"> BATAL</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">PAGE D'AUTHENTIFICATION</p>
